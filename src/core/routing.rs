...
impl<Context> Route<Context> {
    pub fn new(path: &'static str, handler: RouteHandler<Context>) -> Result<Route<Context>> {
    ...
    pub fn matches<'a>(&self, path: &'a str) -> Option<Identifiers<'a>> {

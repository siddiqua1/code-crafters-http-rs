...
//     AsyncRouteHandler, Identifiers, Route, RouteHandler, Routeable, SyncRouteHandler,
// };
// use anyhow::anyhow;
// use anyhow::Result;
...
// pub struct RouteTable<Context: Clone + 'static> {
//     routes: HashSet<Route<Context>>,
// }

// impl<Context: Clone + 'static> Routeable<Context> for RouteTable<Context> {
//     fn new() -> Self {
//         return RouteTable {
//             routes: HashSet::new(),
//         };
...
//                 return Some((route.handler.clone(), scope));
//             }
//         }
//         return None;
//     }
